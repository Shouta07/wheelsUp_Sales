...
## 採点ルーブリック (各軸 0〜10 点の振る舞いを明文化。これに照らして整数で採点)

### needs (ニーズ深掘り)
- 10点: 候補者の発言の真因を 3 層以上掘る (例: 「年収を上げたい」→「なぜ年収？」→「家族が増えたから」→「育休中の不安？」)
- 7-8点: 1〜2 層は掘り下げる質問あり
- 4-6点: 表層理由で止まる。「なぜ」を 1-2 回しか聞かない
- 1-3点: 質問せず自社案件を一方的に話す、または候補者の話を遮る
- 0点: ニーズに一切関心を示さない

### proposal (提案力)
- 10点: 候補者の状況に合う **具体的な企業名** を 3 社以上提示し、それぞれのマッチ理由を説明
- 7-8点: 1〜2 社の具体的提案、マッチ理由あり
- 4-6点: 抽象的な業界提案のみ (例: 「不動産業界どうですか」)
- 1-3点: 求人提案なし、または候補者の希望と無関係
- 0点: 提案を一切しない

### trust (信頼構築)
- 10点: 業界の構造的な話 (年収帯・後期負担・キャリアパス) を 3 つ以上提示し、市場の実態を **正直に** 伝える
- 7-8点: 業界知識を 1〜2 個提示、専門用語を適切に使う
- 4-6点: 一般論レベル、業界知識の浅さが見える
- 1-3点: 候補者より知識が少ない印象を与える
- 0点: 嘘や誇張で信頼を損ねる

### closing (クロージング)
- 10点: 「来週水曜までに 3 社送ります」のような **具体的期限 + 具体的アクション** を約束
- 7-8点: 期限はないが具体的アクションを約束
- 4-6点: 「またご連絡します」程度の曖昧な約束
- 1-3点: 次のアクションが決まらない / 候補者主導
- 0点: 面談が空中分解する

### intel (情報収集)
- 10点: 他社エージェント名・選考フェーズ・意思決定者 (家族/上司)・温度感の **4 つすべて** 把握
- 7-8点: 上記の 2〜3 個は把握
- 4-6点: 「他にも見てる」程度しか聞けてない
- 1-3点: 競合状況を一切聞かない
- 0点: 自社視点だけで会話が完結
...
- 業界の構造や年収帯を解説 → **trust**
- 次の面談日や提出期限を決める → **closing**

## Few-shot 例 (LLM が採点感覚を掴むためのサンプル)

### サンプル A (高得点パターン)
発言: 「年収を上げたいんです」「なぜですか？」「家族が増えるんです」「育休中の生活に不安が？」「実は妻も働けなくて...」
→ needs: 9 (3 層掘った), trust: -, intel: -

### サンプル B (低得点パターン)
発言: 「年収を上げたい」「分かりました。じゃあ X 社さんいかがですか？年収 800 万狙えますよ」
→ needs: 3 (なぜを聞かず即提案), proposal: 6 (具体企業), intel: 1 (他社状況聞かず)
