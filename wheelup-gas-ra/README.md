...
1. **🤖 URL 自動補完 (10 社)** → 10 件成功 など
2. **🕸 求人クロール (15 社)** → 新規 N 件 など
3. **🎯 候補者マッチ (15 求人)** → 実行待ち X 件 など
4. 「実行待ち」タブを開く → ◎○ が並ぶ 🎉

完了。翌朝 7 時から cron が自動で回り始める。
...
| dailyCron 6 分超過 | 求人多すぎ / 候補者多すぎ | runEnrich/Crawl/Match の limit を小さくする (例: 5 / 10 / 10) |
